...
st.title("\U0001f4ac Fake News Detector \U0001f4ac")
box_display = '<p style="font-family:sans-serif; color:#ffe456; font-size: 25px;-webkit-text-stroke-width:1px; -webkit-text-stroke-color:black ;">Enter News Here \U0001F447</p>'
st.markdown(box_display, unsafe_allow_html = True)
input_sms = st.text_area("")

if st.button("ChecK News"):
    if input_sms is "":
        empty_display = '<p style="font-family:sans-serif; color:#ffe456; font-size: 40px; -webkit-text-stroke-width:1.4px; -webkit-text-stroke-color:black ;">\U0001F60A Please Enter Some News \U0001F60A</p>'
        ...
        #4.display
        if result  == 0:
            display_message = '<p style="font-family:sans-serif; color:RED; font-size: 40px;">\U000026A0 Alert It\'s A Fake News \U000026A0</p>'
            st.markdown(display_message, unsafe_allow_html = True)
            
        else:
            display_message = '<p style="font-family:sans-serif; color:Green; font-size: 40px;">\U00002714 It\'s A Real News \U00002714</p>'
            st.markdown(display_message, unsafe_allow_html = True)
